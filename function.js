...
function hitungharga() {
  if (kategori.value == 'Adidas') {
    hargakg = 50000;
    jumlahukuran = ukuran.value;

    harga.value = jumlahukuran * hargakg;
  } else if (kategori.value == 'Bloods') {
    hargakg = 40000;
    jumlahukuran = ukuran.value;

    harga.value = jumlahukuran * hargakg;
  } else if (kategori.value == 'Denim') {
    hargakg = 55000;
    jumlahukuran = ukuran.value;

    harga.value = jumlahukuran * hargakg;
  } else if (kategori.value == 'Levis') {
    hargakg = 20000;
    jumlahukuran = ukuran.value;

    harga.value = jumlahukuran * hargakg;
  } else if (kategori.value == 'GajahDuduk') {
    hargakg = 35000;
    jumlahukuran = ukuran.value;

    harga.value = jumlahukuran * hargakg;
  } else if (kategori.value == 'Beverly') {
    hargakg = 30000;
    jumlahukuran = ukuran.value;
